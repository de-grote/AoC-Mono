...
fn get_solution(day: u8, part: u8) -> (String, Duration) {
    ...
    match (day, part) {
        ...
        (15, 1) => solution!(day15, part1),
        (15, 2) => solution!(day15, part2),
        (16, 1) => solution!(day16, part1),
        (16, 2) => solution!(day16, part2),
        (17, 1) => solution!(day17, part1),
        (17, 2) => solution!(day17, part2),
        (18, 1) => solution!(day18, part1),
        (18, 2) => solution!(day18, part2),
        (19, 1) => solution!(day19, part1),
        (19, 2) => solution!(day19, part2),
        (20, 1) => solution!(day20, part1),
        (20, 2) => solution!(day20, part2),
        (21, 1) => solution!(day21, part1),
        (21, 2) => solution!(day21, part2),
        (22, 1) => solution!(day22, part1),
...
fn run_all() -> (String, Duration) {
    ...
    for (day, part) in (1..=25).cartesian_product(1..=2) {
        if [(14, 2), (25, 2)].contains(&(day, part)) {
            // d14p2 is excluded from benchmarks since it requires human interaction
            // d25p2 is excluded since it doesn't exist
            continue;
        }
